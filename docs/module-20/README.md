...
| **Técnico de Laboratorio** | Ingresa los resultados al sistema. Recibe notificaciones cuando un resultado es rechazado. |
...
> El diagrama se genera desde `casos-de-uso.puml` usando PlantUML.
> También disponible en: https://www.plantuml.com/plantuml/uml/sozlqCRnJylv
